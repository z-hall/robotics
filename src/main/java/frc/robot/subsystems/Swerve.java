...
public class Swerve extends Subsystem {
    ...
    public void calculateVisionVectors(double z) {
        ...
        double brAngle = (RobotMath.rad2deg(Math.atan2(a, c)));
        double blAngle = (RobotMath.rad2deg(Math.atan2(a, d)));
        double frAngle = (RobotMath.rad2deg(Math.atan2(b, c)));
        double flAngle = (RobotMath.rad2deg(Math.atan2(b, d)));
