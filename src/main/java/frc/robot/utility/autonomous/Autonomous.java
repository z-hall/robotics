...
public class Autonomous {
    ...
    public void drive() {
        ...
        double blHeading = Pathfinder.boundHalfDegrees(Pathfinder.r2d(blFollower.getHeading())); // Bound
                                                                                                 // to
                                                                                                 // -180..180
                                                                                                 // degrees
        ...
        double brHeading = Pathfinder.boundHalfDegrees(Pathfinder.r2d(brFollower.getHeading())); // Bound
                                                                                                 // to
                                                                                                 // -180..180
                                                                                                 // degrees
